  ...
  return (
    <div className="nutrition">
      <div className="wrapper-nutrition">
        <div className="info-wrapper-nutrition">
          <svg
            width="60"
            height="60"
            viewBox="0 0 60 60"
          ...
          <div className="wrapper-quantity-nutrition">
            <div className="quantity-nutrition">
              {prop.nutrition?.calorieCount} kCal
            </div>
            <span className="calorie">Calories</span>
          </div>
        </div>
      </div>
      <div className="wrapper-nutrition">
        <div className="info-wrapper-nutrition">
          ...
          <div className="wrapper-quantity-nutrition">
            <div className="quantity-nutrition">
              {prop.nutrition?.proteinCount} g
            </div>
            <span className="proteine">Protéines</span>
          </div>
        </div>
      </div>
      <div className="wrapper-nutrition">
      ...
      <div className="wrapper-nutrition">
        <div className="info-wrapper-nutrition">
          ...
          <div className="wrapper-quantity-nutrition">
            <div className="quantity-nutrition">
              {prop.nutrition?.lipidCount} g
            </div>
            <span className="lipide">Lipides</span>
          </div>
        </div>
      </div>
    </div>
